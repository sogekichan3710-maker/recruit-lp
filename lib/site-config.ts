...
export const FAQS = [
  {
    q: "未経験でも本当に稼げますか？",
    a: "はい。中洲でも比較できない高還元システムで、頑張った分がそのまま給与へ反映されます。未経験スタートから月収200万円以上を達成したキャストも在籍しています。",
  },
  {
    q: "学生・Wワークでも働けますか？",
    a: "可能です。学業や本業との両立を前提にしたシフト相談に対応しており、無理なく自分のペースで始められます。",
  },
  {
    q: "ノルマや罰金はありますか？",
    a: "一切ありません。ノルマ・罰金・過度なプレッシャーのない環境で、安心して自分らしく成長していただけます。",
  },
  {
    q: "無料送迎はどこまで対応していますか？",
    a: "営業終了後、0:30〜4:00の時間帯で無料送迎を実施しています。遠方エリアにお住まいの方も安心してご帰宅いただけます。",
  },
  {
    q: "お酒が苦手でも働けますか？",
    a: "問題ございません。無理な飲酒を強いることはなく、会話や雰囲気づくりを楽しんでいただければ大丈夫です。",
  },
  {
    q: "応募から体験入店までの流れを教えてください。",
    a: "まずはLINEから気軽にご連絡ください。その後、簡単な面談・店舗見学を経て、体験入店にご案内します。研修・教育マニュアルも完備しているので未経験でも安心です。",
  },
];
